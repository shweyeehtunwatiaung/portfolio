                                                        ...
                                                        <ul class="geodir-post-image geodir-images clearfix">
                                                            <li>
                                                                <a href='{{ route('shop', $shop->id) }}'>
                                                                    <img src="{{ asset( 'upload/profile/' .$shop->image) }}" width="250px" height="250px" class="" />
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                        ...
                                        <div class="gd-list-item-right ">
                                            ...
                                            @foreach($shop->categories as $category)
                                                <div class="gd-badge-meta gd-badge-alignleft" title="{{ $category->name }}">
                                                    <div class="gd-badge" style="background-color:#ffb100;color:#ffffff;"><i class="fas fa-certificate"></i>
                                                        <a href='{{ route('shop', $shop->id) }}' class='gd-read-more  gd-read-more-fade'>
                                                        <span class='gd-secondary'>{{ $category->name }}</span>
                                                        </a>
                                                    </div>
                                                </div>
                                            @endforeach
