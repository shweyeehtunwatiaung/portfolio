                        ...
                        @if($shop->image)
                            <div class="center-gallery">
                                <div class="bx-wrapper"   >
                                        <img src="{{ asset( 'upload/profile/' . $shop->image) }}" width="750px" height="" class=""
                                        alt="User Image">
                                </div><!-- -->
                            </div>
                        @endif
                                            ...
                                            <div class="geodir-image-container geodir-image-sizes-medium_large ">
                                                <div id="geodir_images_5de6cafacbba5_180" class="geodir-image-wrapper" data-controlnav="1" data-slideshow="1">
                                                    <ul class="geodir-gallery geodir-images clearfix">
                                                            ...
                                                            <li>
                                                                <a href="" class="geodir-lightbox-image" target="_blank">
                                                                    <img src="{{ asset( 'upload/profile/' . $shop->image) }}" width="1440" height="960">
                                                ...
                                                <div class="geodir-image-container geodir-image-sizes-medium_large ">
                                                    <div id="geodir_images_5de6cafacbba5_180" class="geodir-image-wrapper" data-controlnav="1" data-slideshow="1">
                                                        <ul class="geodir-gallery geodir-images clearfix">
                                                            @if($shop->image)
                                                            <div>
                                                                <img src="{{ asset( 'upload/profile/' . $shop->image) }}" width="50px" height="50px" class=""
                                                                alt="User Image">
                                                            </div>
                                                            @endif
                                                            @foreach($shop->photos as $photo)
